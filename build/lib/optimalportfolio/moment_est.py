...
runfile('/home/sven/Documents/PyDox/Quant_OptimalPortfolio/portfolioopt/exp_max.py', wdir='/home/sven/Documents/PyDox/Quant_OptimalPortfolio/portfolioopt')
...
class MLE:
    ...
    def st_est(self):
        ...
        :rtype: pd.Dataframe
        """
        self.mean, self.cov = expected_returns(self.invariants, max_iter=1000)
        self.skew = 0
        self.kurt = 6
